 ...
 * scale length, rT, is a linear function of vMax. This crude approximation comes
 * from trying to make the arctan rotation curves resemble the URC rotation curves
 * as best as possible while keeping the relationship between rT and vMax
 * relatively simple.
 ...
 *
 */
public class GalaxyModel11 implements GalaxyModel {
	/**
	 ...
	 */
	public GalaxyModel11(double vMax, String sechFile) {
		this.vMax = vMax;
		rT = (0.00505213*vMax/1000 + 0.87178343)*Kpc;
