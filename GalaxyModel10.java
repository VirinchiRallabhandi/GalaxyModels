 ...
 *
 */
public class GalaxyModel10 implements GalaxyModel {
	/**
	 ...
	 */
	public GalaxyModel10(double vMax, String sechFile) {
		this.vMax = vMax;
	...
	private double URC(double r) {
		return vMax*(1 - pow(E, -r/1.9905/r0));
	}
	...
	private double dURCdr(double r) {
		return vMax/1.9905/r0*pow(E, -r/1.9905/r0);
	}
