 ...
 * This class differs from GalaxyModel4 by using a URC parameterisation very
 * similar to GalaxyModel1.
 * All units are SI unless otherwise stated.
 * @author Virinchi Rallabhandi
 *
 */
public class GalaxyModel7 implements GalaxyModel {
	/**
	...
	private double vMax;
	/**
	 * The lambda parameter of the URC
	 */
	...
	/**
	 * @param vMax The maximum rotation velocity of an object within the galaxy
	 ...
	 */
	public GalaxyModel7(double vMax, String sechFile) {
		...
		double luminosity = pow(10, -0.4*(mR - 4.61));
		double stellarMass = luminosity*pow(10,-1.578 - 0.0856*mR)*1.989*pow(10, 30);
		//Using the R band mass to light ratio
		maxDensity = stellarMass/8/PI/z0/r0/r0;
		alpha = 1.5*pow(luminosity/pow(10, 10.4), 0.2);
		beta = 0.72 + 0.44*log10(luminosity/pow(10, 10.4));
		rMax = vMax*pow(10, 9)*365.25*24*3600/2/PI;
		v0 = vMax;
		//Fit the correct value of v0 so that maximum velocity of
		double maxVFound = 0;
